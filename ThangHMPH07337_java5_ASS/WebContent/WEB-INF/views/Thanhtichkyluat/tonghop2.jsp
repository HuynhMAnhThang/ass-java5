...
<nav class="navbar navbar-default navbar-fixed-top">
	<div class="container-fluid">
		<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><i class="fa fa-user-circle" aria-hidden="true"></i>TỔNG HỢP/TỔNG HỢP PHÒNG BAN</a>
		</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<a class="font13px" href="Thanhtichkyluat/tonghop.htm" data-toggle="tooltip" data-placement="bottom" title=""><b>TỔNG HỢP</b> <span class="caret"></span> </a>
						<ul class="dropdown">
							...
							<li>
								<a href="Thanhtichkyluat/tonghop2.htm" data-toggle="tooltip" data-placement="bottom" title="TỔNG HỢP PHÒNG BAN"><b>TỔNG HỢP PHÒNG BAN </b></a>
							</li>
						</ul>
					</li>
					<li>
