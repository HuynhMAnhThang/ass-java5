...
<nav class="navbar navbar-default navbar-fixed-top">
	<div class="container-fluid">
		<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><i class="fa fa-user-circle" aria-hidden="true"></i> ĐỔI MẬT KHẨU</a>
		</div>
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="nav navbar-nav navbar-right" style="width: 800px">
					...
					<li>
						<a class="font131px" data-toggle="tooltip"  data-placement="bottom" title=""><input class="ten" name="id" id="id" style="width: 150px" value="${sessionScope.fullname}"> <span class="caret"></span> </a>
							<ul class="dropdown">
								<li class="active">
...
<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100" style="background: linear-gradient(120deg,#c7d2dd,#f8d471); margin-top: 50px;height: 687px; box-shadow:  0 6px 8px #8f8282; ">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="<%=request.getContextPath()%>/images/Key-icon.png" alt="IMG">
				</div>

			<form action="doimatkhau.htm" class="login100-form validate-form" method="post">
				<span class="login100-form-title"> <i class="fa fa-user-circle-o" aria-hidden="true"></i><Br> ĐỔI MẬT KHẨU </span>
				<div class="wrap-input100 validate-input" data-validate="Email sai hãy làm theo ví dụ: ex@abc.xyz">
						<input class="input100" type="password" placeholder="Nhập mật khẩu cũ" name="mkcu" id="mkcu" value="" />
						<br>
						 <input class="input100" type="password" placeholder="Nhập mật khẩu mới" name="mkmoi" id="mkmoi" value="" />
						<br>
						<input class="input100" type="password" placeholder="Nhập lại mật khẩu mới" name="mkmoi1" id="mkmoi1" value="" />
				</div>
					...
					<div class="text-center p-t-12">
						...
						<a class="txt2" href="log/dangnhap.htm">Đến trang đăng nhập </a>
					</div>
		 </form>
		</div>
	</div>
