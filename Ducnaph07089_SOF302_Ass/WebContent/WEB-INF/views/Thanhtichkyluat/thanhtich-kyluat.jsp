...
<body onload="time()">
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><i class="fa fa-user-circle"
					aria-hidden="true"></i> THÀNH TÍCH & KỶ LUẬT</a>
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active"><a
						href="Thanhtichkyluat/thanhtich-kyluat.htm" data-toggle="tooltip"
						data-placement="bottom" title="THÀNH TÍCH & KỶ LUẬT">THÀNH
							TÍCH & KỶ LUẬT</a></li>
	...
	<div class="container-fluid al">
		<div class="form">
			<form:form action="Thanhtichkyluat/thanhtich-kyluat.htm"
				...
				<table class="tb1">
					...
					<tr>
						...
						<td><form:input path="date" cssClass="in" /></td>
					</tr>
					<tr>
						<th class="t1">Loại</th>
						<th>Mã Nhân viên</th>
					...
					<tr>
						<td><form:radiobutton path="type" value="true"
								label="Thành tích" cssClass="rb" /> <form:radiobutton
								path="type" value="false" label="Kỷ luật" cssClass="rb" /></td>
						<td><form:select path="staff.id" cssClass="in"
								items="${staffs}" itemValue="id" itemLabel="id" /></td>
					</tr>
					<tr>
						<th class="t1">Lý do</th>
					</tr>
					<tr>
						<td><form:input path="reason" cssClass="in" /></td>
					</tr>
				</table>
		...
		<input type="text" id="myInput" onkeyup="myFunction()"
			placeholder="Nhập mã thành tích kỷ luật cần tìm..."
			data-toggle="tooltip" data-placement="bottom"
			title="Tìm Kiếm Nhân Viên"><br> <i class="fa fa-search"
			aria-hidden="true"></i>
