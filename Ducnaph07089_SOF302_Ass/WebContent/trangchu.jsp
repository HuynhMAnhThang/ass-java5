		...
		<div class="container">
			...
			<div class="owl-carousel testimonials-carousel">
				...
				<div class="testimonial-item">
					<p>
						<i class="	fa fa-quote-left"></i> Proin iaculis purus consequat
						sem cure digni ssim donec porttitora entum suscipit rhoncus.
						Accusantium quam, ultricies eget id, aliquam eget nibh et. Maecen
						aliquam, risus at semper. <i
				...
				<div class="testimonial-item">
					<p>
						<i class="	fa fa-quote-left"></i> Export tempor illum tamen malis
						malis eram quae irure esse labore quem cillum quid cillum eram
						malis quorum velit fore eram velit sunt aliqua noster fugiat irure
						amet legam anim culpa. <i
							class="bx bxs-quote-alt-right quote-icon-right"></i>
					</p>
				...
				<div class="testimonial-item">
					<p>
						<i class="	fa fa-quote-left"></i> Enim nisi quem export duis
						labore cillum quae magna enim sint quorum nulla quem veniam duis
						minim tempor labore quem eram duis noster aute amet eram fore quis
						sint minim. <i class="bx bxs-quote-alt-right quote-icon-right"></i>
					</p>
				...
				<div class="testimonial-item">
					<p>
						<i class="	fa fa-quote-left"></i> Fugiat enim eram quae cillum
						dolore dolor amet nulla culpa multos export minim fugiat minim
						velit minim dolor enim duis veniam ipsum anim magna sunt elit fore
						quem dolore labore illum veniam. <i
							class="bx bxs-quote-alt-right quote-icon-right"></i>
					</p>
				...
				<div class="testimonial-item">
					<p>
						<i class="	fa fa-quote-left"></i> Quis quorum aliqua sint quem
						legam fore sunt eram irure aliqua veniam tempor noster veniam enim
						culpa labore duis sunt culpa nulla illum cillum fugiat legam esse
						veniam culpa fore nisi cillum quid. <i
							class="bx bxs-quote-alt-right quote-icon-right"></i>
					</p>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-2 col-md-6 footer-links">
						<h4>Useful Links</h4>
						<ul>
							<li><i class="fa fa-chevron-right" style="font-size:12px"></i></i> <a href="#">Home</a></li>
							<li><i class="fa fa-chevron-right" style="font-size:12px"></i></i> <a href="#">About
									us</a></li>
							<li><i class="fa fa-chevron-right" style="font-size:12px"></i></i> <a href="#">Terms
									of service</a></li>
							<li><i class="fa fa-chevron-right" style="font-size:12px"></i></i> <a href="#">Privacy
									policy</a></li>
						</ul>
					</div>
					...
					<div class="col-lg-3 col-md-6 footer-links">
						<h4>Our Services</h4>
						<ul>
							<li><i class="fa fa-chevron-right" style="font-size:12px"></i></i> <a href="#">Web
									Design</a></li>
							<li><i class="fa fa-chevron-right" style="font-size:12px"></i></i> <a href="#">Web
									Development</a></li>
							<li><i class="fa fa-chevron-right" style="font-size:12px"></i></i> <a href="#">Product
									Management</a></li>
							<li><i class="fa fa-chevron-right" style="font-size:12px"></i></i> <a href="#">Marketing</a></li>
							<li><i class="fa fa-chevron-right" style="font-size:12px"></i></i> <a href="#">Graphic
									Design</a></li>
						</ul>
					</div>
